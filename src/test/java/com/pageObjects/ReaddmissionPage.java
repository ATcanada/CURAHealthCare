...
public class ReaddmissionPage extends BasePage{
	
	public WebDriverWait wait;
	public JavascriptExecutor js;
	public Actions action;
	public ReaddmissionPage(WebDriver driver) {
		super(driver);
...
//	public WebElement datepick ; 
	...
	public WebElement readmissioncheck; 
	...
	public String facility_ReAdd() throws TimeoutException {
	...
	public List<WebElement> health_program_ReAdd() throws TimeoutException {
		wait = new WebDriverWait(driver, 10);
	...
	public WebElement date_pick() {
		...
		datepick.sendKeys("18/08/2023");
		String date=datepick.getAttribute("value");
		return datepick;
	}
	
	public WebElement ReAddmission_Ch() throws TimeoutException {
		wait = new WebDriverWait(driver, 10);
		wait.until(ExpectedConditions.elementToBeClickable(readmissioncheck));
		return readmissioncheck;
		
	//	return readmissioncheck.isSelected();
